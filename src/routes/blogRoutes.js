...
router.get('/', getBlogsValidator, validate, blogController.getAllBlogs);
router.get('/:id', getBlogValidator, validate, blogController.getBlogById);
router.put('/:id', auth, authorizeBlogOwner, updateBlogValidator, validate, blogController.updateBlog);
router.delete('/:id', auth, authorizeBlogOwner, getBlogValidator, validate, blogController.deleteBlog);
